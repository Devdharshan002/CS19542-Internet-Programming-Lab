                            ...
                            <?php
                                ...
                                if ($result->num_rows == 0) {
                                    ...
                                    for ($x = 0; $x < $result->num_rows; $x++) {
                                        ...
                                        $nop = $row["nop"];
                                        echo '<tr>
                                            <td style="text-align:center; vertical-align: middle;">&nbsp;' . substr($title, 0, 30) . '</td>
                                            <td style="text-align:center; vertical-align: middle;">' . substr($docname, 0, 20) . '</td>
                                            <td style="text-align:center; vertical-align: middle;">' . substr($scheduledate, 0, 10) . ' ' . substr($scheduletime, 0, 5) . '</td>
