                            ...
                            <?php
                                ...
                                if ($result->num_rows == 0) {
                                    ...
                                    for ($x = 0; $x < $result->num_rows; $x++) {
                                        ...
                                        echo '<tr>
                                            <td style="text-align: center; vertical-align: middle;"> &nbsp;' . substr($name, 0, 35) . '</td>
                                            <td style="text-align: center; vertical-align: middle;">' . substr($tel, 0, 10) . '</td>
                                            <td style="text-align: center; vertical-align: middle;">' . substr($email, 0, 20) . '</td>
                                            <td style="text-align: center; vertical-align: middle;">' . substr($dob, 0, 10) . '</td>
