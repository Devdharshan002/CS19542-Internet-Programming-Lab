    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%" >
                    <a href="index.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:225px"><font class="tn-in-text">Back to Dashboard</font></button></a>
                    </td>
                    <td>
                            ...
                            <?php
                                ...
                                if ($result->num_rows == 0) {
                                    ...
                                    for ($x = 0; $x < $result->num_rows; $x++) {
                                        ...
                                        echo '<tr>
                                            <td style="font-weight:600; text-align:center; vertical-align:middle;"> &nbsp;' . substr($pname, 0, 25) . '</td>
                                            <td style="text-align:center; font-size:23px; font-weight:500; color: var(--btnnicetext); vertical-align:middle;">' . $apponum . '</td>
                                            <td style="text-align:center; vertical-align:middle;">' . substr($docname, 0, 25) . '</td>
                                            <td style="text-align:center; vertical-align:middle;">' . substr($title, 0, 15) . '</td>
                                            <td style="text-align:center; font-size:12px; vertical-align:middle;">' . substr($scheduledate, 0, 10) . '<br>' . substr($scheduletime, 0, 5) . '</td>
                                            <td style="text-align:center; vertical-align:middle;">' . $appodate . '</td>
